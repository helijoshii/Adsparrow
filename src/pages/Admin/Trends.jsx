...
const Trends = () => {
  ...
  <div class="row g-2">
    ...
    <div class="col-lg-auto  col-md-auto col-sm-auto">
      <select class="select2 js-example-basic-single select-label form-control w-100" name="select-label">
        <option value="Senora" selected>Ad Account name</option>
    ...
    <div class="col-lg-auto  col-md-auto col-sm-auto">
      <select class="select2 js-example-basic-single select-label form-control w-100" name="select-label">
        <option value="Senora" selected>Select Status</option>
    ...
    <div class="col-lg-auto  col-md-auto col-sm-auto">
      <div class="d-flex align-items-center">
        ...
        <FontAwesomeIcon icon={faCalendarDays} />&nbsp;
          <span>November 9, 2025 - November 15, 2025</span> <i class="fa fa-caret-down"></i>
        </div>
        <a href="#" class="btn btn-primary ms-2"><FontAwesomeIcon icon={faMagnifyingGlass} /></a>
        <a href="#" class="btn btn-danger ms-2"><FontAwesomeIcon icon={faXmark} /></a>
      </div>
    </div>
            ...
            <div class="amount_spend">
              ...
              <ul class="tabs">
                ...
                <li class="tab-link" data-tab="tab-2">
                  <span>
                    <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 453.15">
                      <g id="Layer_1-2" data-name="Layer 1">
                        <g>
                          <path class="cls-2"
                ...
                <li class="tab-link" data-tab="tab-4">
                  <span>
                    <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 275.34 496">
                      <g id="Layer_1-2" data-name="Layer 1">
                        <g>
                          <g>
                            <path class="cls-1"
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex justify-content-center">
                    ...
                    <button type="button" class="btn btn-primary small_bt" data-bs-toggle="modal" data-bs-target="#Budget">
                ...
                <td>
                  <p class="mb-0">
                    <span class="d-flex justify-content-center align-items-center"><i
                        class="fa fa-calendar-alt me-2"></i>27/03/2021<br /></span>
                    <span class="d-flex justify-content-center align-items-center time_span"><i
                        class="fa fa-clock me-2"></i>07:00AM</span>
                  </p>
                </td>
              </tr>
              <tr>
